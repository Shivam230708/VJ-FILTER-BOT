...
PICS = (environ.get('PICS', 'https://envs.sh/c_k.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7806825662 7500269454 8055384069').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7806825662 7500269454 8055384069').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002385687820') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002371063275')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002431776554')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002371063275')).split()]  # For Multiple Id Use One Space Between Each.
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://teamdaxx123:teamdaxx123@cluster0.ysbpgcp.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'File01Channel') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BotVerseRaviSupport')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/BotVerseRavi')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'BotVerseRaviSupport') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Unknown_RK01')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '0678515ec8fb3323f21ceff97792edd4d4147e11')
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://tinyurl.com/')
SHORTLINK_API = environ.get('SHORTLINK_API', 'FpvjsM5Xfsc6f7YSobWlYiLGX0U6Jwhvx4X5ZXe1hyaFrGuZfE0R5mAwenbH')
